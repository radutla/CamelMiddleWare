            ...
            <salesorderebo:UpdateSalesOrderLineStatusList>
               ...
               <corecom:Identification>
                  ...
                  <corecom:ApplicationObjectKey>
                     ...
                     <xsl:if test="dvm:lookupValue('oramds:C:/Data/Salto AIA/DVMs/NOTIFICATION_SUBJECT.dvm','MCOM_Notification',tns:EventDataOrderProgress/tns:notification/req1:subject,'SHE_Notification','INVALID VALUE') != 'INVALID VALUE'">
                        <corecom:ContextID>
